...
*   **🧠 [MindNav BCI](https://github.com/Sakib-Dalal/Mind-Nav)**  
    *A hardware-software hybrid BCI streaming neocortex pyramidal neuron EEG signals to control real-time navigation.*  
    `Python` `Arduino` `Deep Learning` `GUI Development`
    
*   **🛡️ [BCIShield](https://github.com/Vasco1290/BCIShield)**  
    *Research evaluating vulnerability of EEG motor imagery classifiers under adversarial attacks.*  
    `PyTorch` `Adversarial ML` `Signal Processing` `Robustness`

*   **🚀 [PhishBrain / SecRAG](https://github.com/Vasco1290/SecRAG)**  
    *An intelligent open-source, security-focused RAG agent and explainable classifier for URL classification.*  
    `FastAPI` `LangChain` `Vector DB` `LLM Systems`
